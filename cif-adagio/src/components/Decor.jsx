...
export const BalletFlourish = ({ size = 40, color = "#2F7F92", className = "", animateDraw = false }) => (
...
export const PremiumPattern = () => (
  <svg className="pointer-events-none absolute inset-0 h-full w-full" style={{ opacity: 0.3 }} preserveAspectRatio="none" viewBox="0 0 380 760" xmlns="http://www.w3.org/2000/svg">
    <path d="M-20 40 L120 200 M40 -20 L220 180 M280 -20 L440 160" stroke="#B8935B" strokeWidth="1" />
    <path d="M260 620 L420 760 M180 680 L360 760 M320 540 L460 700" stroke="#2F7F92" strokeWidth="1" />
