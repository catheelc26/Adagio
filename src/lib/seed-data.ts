...
export const PILLARS: PillarSeed[] = [
  ...
  },
  {
    ...
    videos: [
      ...
      {
        title: "Cuidado del pie y el tobillo en danza",
        description: "Movilidad, estabilidad y fortalecimiento específico.",
        tag: "INICIAR",
      },
      ...
      {
        title: "Vuelta a la danza tras una lesión",
        description: "Progresión segura de carga para regresar a la técnica completa.",
        tag: "AVANZADO",
      },
      {
        title: "Gestión del dolor crónico en la profesión",
        description: "Estrategias fisioterapéuticas para carreras largas y sostenibles.",
        tag: "AVANZADO",
      },
    ],
  },
  {
    ...
    videos: [
      {
        title: "El powerhouse: tu centro de control",
        description: "Activación del core al servicio del movimiento, no en su contra.",
        tag: "INICIAR",
        isPreview: true,
      },
      {
        title: "PBT: conciencia del pie plantígrado",
        description: "Ejercicios con banda para activar la musculatura del pie y el tobillo.",
        tag: "INICIAR",
      },
      ...
      {
        title: "Resistencia muscular para funciones largas",
        description: "Cómo entrenar la fuerza que se sostiene durante toda una función.",
        tag: "AVANZADO",
      },
      {
        title: "PBT avanzado: estabilidad en un pie",
        description: "Retos de equilibrio progresivos para relevé y giros.",
        tag: "AVANZADO",
      },
    ],
  },
  {
    ...
    videos: [
      {
        title: "Respiración diafragmática para bailarines",
        description: "La base de toda práctica: aprender a respirar con el cuerpo entero.",
        tag: "INICIAR",
        isPreview: true,
      },
      {
        title: "Secuencia de movilidad matutina",
        description: "20 minutos para despertar el cuerpo antes de clase o función.",
        tag: "INICIAR",
      },
      ...
      {
        title: "Inversiones con seguridad",
        description: "Progresiones hacia el equilibrio invertido con control.",
        tag: "AVANZADO",
      },
      {
        title: "Yoga restaurativo post-función",
        description: "Recuperación activa para el sistema nervioso y el cuerpo.",
        tag: "AVANZADO",
      },
    ],
  },
  {
    ...
    videos: [
      {
        title: "Introducción a la atención plena",
        description: "Una meditación guiada de 10 minutos para empezar a entrenar la mente.",
        tag: "INICIAR",
        isPreview: true,
      },
      {
        title: "Meditación para antes de clase",
        description: "Cómo llegar presente y enfocada al estudio.",
        tag: "INICIAR",
      },
      ...
      {
        title: "Visualización para el repertorio",
        description: "Técnicas de visualización usadas por bailarines de alto nivel.",
        tag: "AVANZADO",
      },
      {
        title: "Meditación para carreras longevas",
        description: "Sostener la motivación y la salud mental a lo largo de los años.",
        tag: "AVANZADO",
      },
    ],
  },
  {
    ...
    videos: [
      {
        title: "El esqueleto en movimiento",
        description: "Un recorrido visual por las estructuras óseas clave en la danza.",
        isPreview: true,
      },
  ...
  },
  {
    ...
    videos: [
      {
        title: "Ejes y planos de movimiento",
        description: "El vocabulario básico de la biomecánica aplicado a pasos cotidianos.",
        isPreview: true,
      },
    ...
    videos: [
      {
        ...
        description: "Una práctica somática para reconectar con las sensaciones del cuerpo.",
        tag: "INICIAR",
        isPreview: true,
      },
      {
        title: "Propiocepción: sentir sin mirar",
        description: "Ejercicios para afinar la percepción interna del movimiento.",
        tag: "INICIAR",
      },
      ...
      {
        title: "De la sensación a la ejecución precisa",
        description: "Cómo la conciencia corporal refina la técnica de más alto nivel.",
        tag: "AVANZADO",
      },
      {
        title: "Conciencia corporal en la creación coreográfica",
        description: "Usar la escucha interna como herramienta artística.",
        tag: "AVANZADO",
      },
    ],
  },
  ...
  for (const [pillarIndex, pillar] of PILLARS.entries()) {
    const createdPillar = await prisma.pillar.upsert({
      ...
      update: {
        ...
        icon: pillar.icon,
        isTheory: Boolean(pillar.isTheory),
      },
      create: {
        slug: pillar.slug,
        name: pillar.name,
    ...
    for (const [videoIndex, video] of pillar.videos.entries()) {
      const existing = await prisma.video.findFirst({
        where: { pillarId: createdPillar.id, title: video.title },
      });
